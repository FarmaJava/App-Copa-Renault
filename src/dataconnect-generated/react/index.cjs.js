const { listPartidosPorDeporteRef, listDivisionesPorDeporteRef, listJugadoresPorEquipoRef, listEquiposPorDivisionRef, listSponsorsRef, jugadorInsertRef, connectorConfig } = require('../index.cjs.js');
